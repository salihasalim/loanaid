# Generated by Django 5.1 on 2025-03-14 09:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guaranter_years', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1900), django.core.validators.MaxValueValidator(2100)])),
                ('application_description', models.TextField(blank=True, null=True)),
                ('bank_name', models.CharField(blank=True, max_length=100, null=True)),
                ('workstatus', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('status_name', models.CharField(choices=[('Accept', 'Accept'), ('Reject', 'Reject'), ('Pending', 'Pending'), ('Under Review', 'Under Review'), ('Approved', 'Approved'), ('Disbursed', 'Disbursed')], default='Pending', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('franchise_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='assignments', to='UserApp.franchise')),
